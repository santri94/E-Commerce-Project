...
<body>
    ...
    <form action="ChangePrice-Query.php" method="post">
    <table class="form" align="center">
        ...
        <tr>
            <td>
                <label><p class="form">New Price :</p></label>
            </td>
    ...
    <p align="center">
        <input class="send" type="Submit" value="Change Price">
    </p>
